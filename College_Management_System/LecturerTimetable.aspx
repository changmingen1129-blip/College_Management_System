<%@ Page Language="C#" AutoEventWireup="true"
    ...
    CodeBehind="LecturerTimetable.aspx.cs"
    Inherits="College_Management_System.LecturerTimetable" %>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:HiddenField ID="hfLecturerName" runat="server" />
    <asp:HiddenField ID="hfScheduleJson" runat="server" />

    <!-- Topbar -->
    <div class="topbar">
        <div>
            <h2 class="page-title">My Teaching Timetable</h2>
            <p class="page-subtitle">
                Your timetable is generated based on schedules assigned to your lecturer account.
            </p>
        </div>
    ...
    <div class="section-card">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <div>
                <h4 class="page-title mb-1">Visual Timetable</h4>
                <p class="text-muted mb-0">
                    Generate and download your teaching timetable as an image.
                </p>
            </div>
        </div>
        ...
        <div class="timetable-wrapper">
            <div id="timetableCaptureArea">
                <div class="empty-preview">
                    Click <strong>Generate Timetable</strong> to show your teaching timetable.
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        function getLecturerName() {
            const hiddenField = document.getElementById("<%= hfLecturerName.ClientID %>");
            if (!hiddenField || !hiddenField.value) return "Lecturer";
        ...
        function renderTimetable() {
            ...
            if (schedules.length === 0) {
                captureArea.innerHTML = '<div class="empty-preview">No teaching timetable found. Please ask admin to assign your schedule.</div>';
                return;
            }
            ...
            exportCard.innerHTML = `
                <div class="tt-export-header">
                    <h3>${escapeHtml(lecturerName)}'s Teaching Timetable</h3>
            ...
            footer.textContent = "This timetable is generated automatically based on your assigned teaching schedule.";
        ...
        if (downloadTimetableButton) {
            downloadTimetableButton.addEventListener("click", function () {
                ...
                html2canvas(captureArea, {
                    ...
                    const lecturerName = getLecturerName().replace(/\s+/g, "_");
                    const link = document.createElement("a");
                    link.download = lecturerName + "_Teaching_Timetable.png";
