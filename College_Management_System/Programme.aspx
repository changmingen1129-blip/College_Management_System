<%@ Page Language="C#" AutoEventWireup="true"
    ...
    CodeBehind="Programme.aspx.cs"
    Inherits="College_Management_System.Programme" %>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="page-header">
        ...
        <p class="page-subtitle">
            Create, update, and manage academic programmes in the system.
        </p>
    </div>
    ...
    <div class="section-card">
        ...
        <h4 class="section-title">Add New Programme</h4>
        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-3">
                ...
                <asp:TextBox ID="txtName" runat="server"
                    ...
                    Placeholder="Example: Diploma in Information Technology"></asp:TextBox>
            </div>
            ...
            <div class="col-md-6 mb-3">
                ...
                <asp:TextBox ID="txtCode" runat="server"
                    CssClass="form-control"
                    Placeholder="Example: DIT"></asp:TextBox>
            </div>
    ...
    <div class="section-card">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <div>
                <h4 class="section-title mb-1">Programme List</h4>
                <p class="text-muted mb-0">
                    All academic programmes registered in the system.
                </p>
            </div>
        </div>
